...
import postsPageInitialPaths5ae51Resource from '../../../resources/posts-page-initial-paths-5ae51'
import postsPageInitialPropsF57e0Resource from '../../../resources/posts-page-initial-props-f57e0'
...
export async function getStaticPaths() {
  try {
    const response = await postsPageInitialPaths5ae51Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsF57e0Resource({
      ...context?.params,
